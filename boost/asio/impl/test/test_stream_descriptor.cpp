...
void test_1() {
  try {
    ...
    boost::asio::posix::stream_descriptor descriptor3(std::move(descriptor3));
#endif
#if defined(BOOST_ASIO_HAS_MOVE)
    ...
    bool non_blocking2 = descriptor1.non_blocking();
    (void)non_blocking2;
    ...
    descriptor1.async_write_some(boost::asio::buffer(mutable_char_buffer),
      write_some_handler);
    descriptor1.async_write_some(boost::asio::buffer(const_char_buffer),
      write_some_handler);
    descriptor1.async_write_some(boost::asio::null_buffers(),
      write_some_handler);
    ...
    (void)l2;
    int l3 = descriptor1.async_write_some(boost::asio::null_buffers(), lazy);
    (void)l3;
    ...
    descriptor1.async_read_some(boost::asio::null_buffers(), read_some_handler);
