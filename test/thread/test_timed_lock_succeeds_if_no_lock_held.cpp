...
struct test_timed_lock_succeeds_if_no_lock_held {
  void operator()() {
...
void do_test_timed_lock_succeeds_if_no_lock_held() {
  test_timed_lock_succeeds_if_no_lock_held()();
}

auto main() -> decltype(0) {
  do_test_timed_lock_succeeds_if_no_lock_held();
  return 0;
}
