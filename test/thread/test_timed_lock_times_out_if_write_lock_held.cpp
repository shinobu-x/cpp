...
struct test_timed_lock_times_out_if_write_lock_held {
  void operator()() {
    ...
    boost::system_time const timeout1 =
      start1 + boost::posix_time::milliseconds(500);
    ...
    timed_lock_succeeded = rwm_mutex.timed_lock(timeout3);
...
void do_test_timed_lock_times_out_if_write_lock_held() {
  test_timed_lock_times_out_if_write_lock_held()();
}

auto main() -> decltype(0) {
  do_test_timed_lock_times_out_if_write_lock_held();
  return 0;
}
